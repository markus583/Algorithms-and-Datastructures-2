...
class TestChainingHashSet(unittest.TestCase):
    ...
    def test_size_without_chaining(self):
        ...
        try:
            ...
            self.assertEqual(
                stud_set.get_table_size(),
                0,
                ".get_table_size() of empty hash set returned "
                + str(stud_set.get_table_size())
                + " but should be 0",
            )

            self.assertTrue(
                self.insert(stud_set, 5),
                ".insert(5) returned False but should be True. ",
            )
            self.assertEqual(
                1,
                stud_set.get_table_size(),
            ...
            self.assertTrue(
                self.insert(stud_set, 6),
                ".insert(6) returned False but should be True ",
            )
            self.assertEqual(
                2,
                stud_set.get_table_size(),
                ".get_table_size() returned "
                + str(stud_set.get_table_size())
                + " but should be 2 ",
            )

            self.assertTrue(
                self.insert(stud_set, 7),
                ".insert(7) returned False but should be True. ",
            )
            self.assertEqual(
                3,
                stud_set.get_table_size(),
            ...
            self.assertTrue(
                self.insert(stud_set, 8),
                ".insert(8) returned False but should be True. ",
            )
            self.assertEqual(
                4,
                stud_set.get_table_size(),
            ...
            self.assertTrue(
                self.insert(stud_set, 9),
                ".insert(9) returned False but should be True. ",
            )
            self.assertEqual(
                5,
                stud_set.get_table_size(),
            ...
            self.assertTrue(
                self.insert(stud_set, 10),
                ".insert(10) returned False but should be True. ",
            )
            self.assertEqual(
                6,
                stud_set.get_table_size(),
            ...
            self.assertTrue(
                self.insert(stud_set, 11),
                ".insert(11) returned False but should be True. ",
            )
            self.assertEqual(
                7,
                stud_set.get_table_size(),
            ...
            self.assertTrue(
                self.insert(stud_set, 12),
                ".insert(12) returned False but should be True. ",
            )
            self.assertEqual(
                8,
                stud_set.get_table_size(),
            ...
            self.assertTrue(
                self.insert(stud_set, 13),
                ".insert(13) returned False but should be True. ",
            )
            self.assertEqual(
                9,
                stud_set.get_table_size(),
            ...
            self.assertTrue(
                self.insert(stud_set, 14),
                ".insert(14) returned False but should be True. ",
            )
            self.assertEqual(
                10,
                stud_set.get_table_size(),
            ...
            self.assertTrue(
                self.insert(stud_set, 15),
                ".insert(15) returned False but should be True. ",
            )
            self.assertEqual(
                11,
                stud_set.get_table_size(),
        ...
        self.assertIsNone(
            ex_caught,
            "Some unhandled exception raised during testing: " + str(ex_caught),
        )
    ...
    def test_size_with_chaining(self):
        ...
        try:
            ...
            self.assertTrue(
                self.insert(stud_set, 25),
                ".insert(25) returned False but should be True. ",
            )
            self.assertEqual(
                12,
                stud_set.get_table_size(),
            ...
            self.assertTrue(
                self.insert(stud_set, 36),
                ".insert(36) returned False but should be True. ",
            )
            self.assertEqual(
                13,
                stud_set.get_table_size(),
            ...
            self.assertTrue(
                self.insert(stud_set, 17),
                ".insert(17) returned False but should be True. ",
            )
            self.assertEqual(
                14,
                stud_set.get_table_size(),
    ...
    def test_insert_without_chaining(self):
        ...
        try:
            ...
            self.assertTrue(
                self.insert(stud_set, 5),
                ".insert(5) returned False on empty hash table but must be True.",
            )
        ...
        try:
            ...
            for i in range(0, len(hash_table)):
                self.assertEqual(
                    ...
                    "hash table at index "
                    + str(i)
                    + "must be None after .clear() but was not ",
                )
    ...
    def test_size_remove_without_chaining(self):
        ...
        try:
            ...
            self.assertTrue(
                stud_set.remove(11), ".remove(11) returned False but must be True "
            )
            ...
            self.assertEqual(
                ...
                + str(stud_set.get_table_size())
                + ") on "
                + "remove key 11 but should be "
                + str(10),
            )

            # /*remove at end of chaining list*/
            self.assertTrue(
                stud_set.remove(12), ".remove(17) returned False but must be True "
            )
            self.assertEqual(
                9, stud_set.get_table_size(), ".get_table_size() returned wrong size"
            )

            # /*remove in mid of chaining list*/
            self.assertTrue(
                stud_set.remove(13), ".remove(25) returned False but must be True "
            )

            self.assertEqual(
                8, stud_set.get_table_size(), ".get_table_size() returned wrong size "
            )

            # /*remove beginning of chaining list*/
            self.assertTrue(
                stud_set.remove(14), ".remove(14) returned False but must be True "
            )
            self.assertEqual(
                7, stud_set.get_table_size(), ".get_table_size() returned wrong size"
            )
    ...
    def test_size_remove_with_chaining(self):
        ...
        try:
            ...
            self.assertTrue(
                stud_set.remove(17), ".remove(17) returned False but must be True "
            )
            ...
            self.assertEqual(
                ...
                + str(stud_set.get_table_size())
                + ") on "
                + "remove key 17 but should be "
                + str(13),
            )

            # /*remove at end of chaining list*/
            self.assertTrue(
                stud_set.remove(36), ".remove(36) returned False but must be True "
            )
            self.assertEqual(
                12, stud_set.get_table_size(), ".get_table_size() returned wrong size"
            )

            # /*remove in mid of chaining list*/
            self.assertTrue(
                stud_set.remove(25), ".remove(14) returned False but must be True "
            )

            self.assertEqual(
                11, stud_set.get_table_size(), ".get_table_size() returned wrong size"
            )
    ...
    def test_struct_remove_without_chaining(self):
        ...
        try:
            ...
            self.assertTrue(
                stud_set.remove(12), ".remove(12) returned False but must be True "
            )
            stud_nodes = stud_set.get_hash_table()
            self.assertEqual(
                None,
            ...
            self.assertTrue(
                stud_set.remove(13), ".remove(13) returned False but must be True "
            )
            stud_nodes = stud_set.get_hash_table()
            self.assertEqual(
                None,
    ...
    def test_struct_remove_with_chaining(self):
        ...
        try:
            ...
            self.assertTrue(
                stud_set.remove(25),
                ".remove(25) returned False but must be True on hash set ",
            )
            stud_nodes = stud_set.get_hash_table()
            self.assertEqual(
                14,
            ...
            self.assertEqual(
                36,
                stud_nodes[3].key,
                "incorrect node at index 3 after .remove(14) "
                + " must be 36 but was not.",
            )
            self.assertEqual(
                None,
                stud_nodes[3].next,
                "incorrect node at index 3.next after .remove(14) "
                + " must be None but was not.",
            )
    ...
    def test_contains_with_chaining(self):
        ...
        try:
            ...
            self.assertTrue(
                stud_set.contains(11), ".contains(11) returned False but must be True  "
            )
            self.assertTrue(
                stud_set.contains(12), ".contains(12) returned False but must be True  "
            )
            self.assertTrue(
                stud_set.contains(13), ".contains(13) returned False but must be True  "
            )
            self.assertTrue(
                stud_set.contains(14), ".contains(14) returned False but must be True  "
            )
            self.assertTrue(
                stud_set.contains(15), ".contains(15) returned False but must be True  "
            )
            self.assertTrue(
                stud_set.contains(5), ".contains(5) returned False but must be True  "
            )
            self.assertTrue(
                stud_set.contains(6), ".contains(6) returned False but must be True  "
            )
            self.assertTrue(
                stud_set.contains(7), ".contains(7) returned False but must be True  "
            )
            self.assertTrue(
                stud_set.contains(8), ".contains(8) returned False but must be True  "
            )
            self.assertTrue(
                stud_set.contains(9), ".contains(9) returned False but must be True  "
            )
            self.assertTrue(
                stud_set.contains(10), ".contains(10) returned False but must be True  "
            )
            self.assertTrue(
                stud_set.contains(25), ".contains(25) returned False but must be True  "
            )
            self.assertTrue(
                stud_set.contains(36), ".contains(36) returned False but must be True  "
            )
            self.assertTrue(
                stud_set.contains(17), ".contains(17) returned False but must be True  "
            )
            self.assertFalse(
                stud_set.contains(18), ".contains(18) returned True but must be False  "
            )
    ...
    def test_insert_false(self):
        ...
        self.assertTrue(
            self.insert(stud_set, 5), "insert(5) returned false but must be true"
        )
        self.assertFalse(
            self.insert(stud_set, 5), "insert(5) returned true but must be false"
        )
        self.assertTrue(
            self.insert(stud_set, 16), "insert(16) returned false but must be true"
        )
        self.assertFalse(
            self.insert(stud_set, 16), "insert(16) returned true but must be false"
        )
    ...
    def test_remove_non_existing(self):
        ...
        self.assertFalse(
            stud_set.remove(1),
            "remove(1) on empty hash table returned true but must be false",
        )
    ...
    def test_contains_false(self):
        ...
        self.assertFalse(
            stud_set.contains(1),
            "contains(1) on empty hash table returned true but must be false",
        )
